...
from build_index import SpacyTokenizer, custom_analyzer  # Import both SpacyTokenizer and custom_analyzer
...
def search_markets(query_str, filter_tags=None, index_dir="indexdir"):
    ...
    Returns up to 10 most relevant markets.
    ...
    try:
        ...
        with ix.searcher(weighting=BM25F()) as searcher:
            ...
            results = searcher.search(parsed_query, filter=filter_query, limit=10)
